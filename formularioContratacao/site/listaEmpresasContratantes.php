                ...
                <tbody>
                    <?php
                        if (isset($_GET['k']) && $_GET['k']) {
                            ...
                            $nomeFiltrado = $query-> fetchAll();

                            $result_count = $query -> fetchColumn();


                            if (!empty($nomeFiltrado) && is_array($nomeFiltrado)) {

                                foreach ($nomeFiltrado as $count){
                                ?>
                                    <tr>
                                        <td><?= $count->Nome ?></td>
                                        <td><?= $count->RG ?></td>
                                        ...
                                        <td><a href="contratoEmpresas.php" class="btn btn-outline-primary" title="Redirecionamento para página do contrato">Contrato</a>
                                        <a href="formEmpresasContratantes?acao=update&idContratante=<?= $count->idContratante ?>" class="btn btn-outline-warning" title="Alteração dos dados do registro">Alterar</a>
                                        <a href="formEmpresasContratantes?acao=delete&idContratante=<?= $count->idContratante ?>" class="btn btn-outline-danger" title="Exclusão do registro">Excluir</a>
                                        </td>
                                    </tr>
                                <?php
                                }
